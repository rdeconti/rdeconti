...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------  
  ...
  - (  *Legenda: Em andamento :yellow_circle: / Em breve :purple_circle: / Concluído :green_circle: / Sem previsão :white_circle:*  )  
    ...
    |               |                     | - Dot.Net             |:yellow_circle:  | Digital Innovation One        |
    |               |                     | - C#                  |:yellow_circle:  | Digital Innovation One        |     
    |               |                     | - Redis               |:white_circle:   |                               |
    |               |                     | - Java                |:green_circle:   | Alura                         |   
    | :three:       |                     |                       |                 |                               |
    | **DATABASE**  | **RDBMS**           | - Oracle              |:white_circle:   |                               |                               
    |               |                     | - MySql               |:white_circle:   |                               |                               
    |               |                     | - SqLite              |:white_circle:   |                               |                               
...
| Origem | Nome | Descrição | Situação | Detalhes |
| ------ | ---- | --------- | -------- | -------- |
| DIO | Desafio 01 - Dividindo X por Y          | Terminal | Em andamento :warning: | <a href="https://github.com/rdeconti/Bootcamp-DIO-.NET-Fundamentals-Desafio01">Link</a> |
...
| DIO | Desafio 04 - Dividindo X por Y          | Terminal | Em andamento :warning: | <a href="https://github.com/rdeconti/Bootcamp-DIO-.NET-Fundamentals-Desafio04">Link</a> |
...
| DIO | Desafio 10 - Validador senha requisito  | Terminal | Em andamento :warning: | <a href="https://github.com/rdeconti/Bootcamp-DIO-.NET-Fundamentals-Desafio10">Link</a> |
